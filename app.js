...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_images_favicon_ico__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_images_favicon_16x16_png__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_images_favicon_32x32_png__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__index_html__ = __webpack_require__(14);
...
module.exports = __webpack_require__.p + "./assets/images/fall.jpg";

/***/ }),
/* 10 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "./assets/images/fall2.jpg";
...
var _user$project$Models$initialModel = F2(
	function (config, route) {
		return {config: config, route: route, title: 'SaPP'};
	});
...
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {config: a, route: b, title: c};
	});
...
var _user$project$Utils_Helpers$pageHeading = F2(
	function (hSize, title) {
		var _p0 = hSize;
		switch (_p0) {
			case 1:
				return A2(
...
var _user$project$Utils_Helpers$infoText = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Application Info'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('flex flex-wrap justify-between border-bottom p2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(model.config.nodeEnv),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('API Url'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.config.apiUrl),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$About_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('page-about'),
			_1: {
				ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('page__feature page__feature--about'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('flex items-center max-width-3 mr-auto ml-auto h100 px2'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('About SaPP'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('page__body max-width-3 mr-auto ml-auto px2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('SaPP is a Front-End toolkit for rapid prototyping. It emphasizes libraries that are intuitive, well-crafted, and easy to use.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('mb0'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_elm_lang$html$Html$ul,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('list-reset m0 center h6'),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('inline-block pr2'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Header_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$header,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('flex flex-wrap items-center p2'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('flex items-center mr-auto'),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('material-icons mr1 h3'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('nature'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('header__app-nav'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('flex items-center justify-end'),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$Home_View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('page-home'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('page'),
				_1: {ctor: '[]'}
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('page__feature page__feature--home'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Style and Prototyping Pack'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Focus on the idea.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Minimize your toolset.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Curabitur vel mauris risus. Nulla venenatis orci ut ligula dignissim volutpat. Curabitur et fringilla est.'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('col-12 sm-col-6 px2'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Point 1'),
																_1: {ctor: '[]'}
															}),
														_1: {
															ctor: '::',
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Cras et iaculis ex, a ultrices metus. Duis sodales tempor erat sed tristique. Aliquam eleifend ut quam pharetra imperdiet.'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Point 2'),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Point 3'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
															...
															_0: A2(
																...
																},
																{
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('Point 4'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'HomeRoute':
			return _user$project$Home_View$view(model);
		case 'AboutRoute':
			return _user$project$About_View$view(model);
		default:
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('app-wrapper'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Header_View$view(model),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$div,
				...
				_1: {
					ctor: '::',
					_0: _user$project$Footer_View$view(model),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$init = F2(
	function (config, location) {
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Models$initialModel, config, currentRoute),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
