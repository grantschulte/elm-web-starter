...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__index_html__ = __webpack_require__(9);
...
var _user$project$Models$initialModel = function (config) {
	return {title: 'Elm Web Starter', config: config};
};
...
var _user$project$Models$Model = F2(
	function (a, b) {
		return {title: a, config: b};
	});

var _user$project$Home_View$infoText = function (config) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('env: '),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(config.nodeEnv),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(config.apiUrl),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('flex items-center pb2 mb2 border-bottom'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _user$project$Home_View$infoText(model.config),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$init = function (config) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Models$initialModel(config),
